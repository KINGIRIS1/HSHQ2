                        ...
                        {filteredDailyRecords.length > 0 ? (
                            filteredDailyRecords.map((r, index) => (
                                <tr key={r.id} className="hover:bg-blue-50/20 group transition-all">
                                    ...
                                    <td 
                                        className="p-4 font-bold text-blue-600 align-middle cursor-pointer hover:underline" 
                                    ...
                                    <td className="p-4 font-bold text-gray-800 truncate align-middle" title={r.customerName}>
                                        {r.customerName}
                                    </td> 
